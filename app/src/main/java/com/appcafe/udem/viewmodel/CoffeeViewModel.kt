...
class CoffeeViewModel(private val coffeeRepository: CoffeeRepository) : ViewModel() {
    ...
    fun buscarCafeteriasNearby(latitud: Double, longitud: Double, apiKey: String) {
        ...
        viewModelScope.launch {
            try {
                ...
                _error.value = "Error al cargar cafeterías: ${e.message}"
            } finally {
    ...
    class Factory(private val repository: CoffeeRepository) : ViewModelProvider.Factory {
        ...
        override fun <T : ViewModel> create(modelClass: Class<T>): T =
            CoffeeViewModel(repository) as T
    }
}
